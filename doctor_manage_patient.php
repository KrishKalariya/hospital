...
while($r=mysqli_fetch_array($result))
{
    ...
    echo "<td>".$r[5]."</td>";
?>
    <td> <a href="patient_edit.php?email=<?php echo $r[2]; ?>"><input type="button" value="Edit"/></a></td>
    <td> <a href="delete.php?email=<?php echo $r[2]; ?>"><input type="button" value="Delete"/></a></td>
<?php
    echo "</tr>";
    $_SESSION['em']=$r[2];
}
