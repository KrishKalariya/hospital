...
$e=@$_GET['email'];
 $q="select * from appointment where email='$e'";
    ...
    <body>
      <section class="contact" id="contact" style="margin-top: 5%;">
        <div class="container"><br/><br/>
          ...
          <form method="post" action="admin_appointment_display.php">
          <h1 class="header">Edit Data</h1>
            ...
            <input type="text" name="email" value="<?php echo $r[1]; ?>"readonly/><br/><br/>

            <label for="mno"><b>Mobile No</b></label><br/>
            <input type="text" name="mno" value="<?php echo $r[2]; ?>"/><br/><br/>

            <label for="date"><b>Date</b></label><br/>
            <input type="date" name="date" value="<?php echo $r[3]; ?>"/><br/><br/>

            <label for="problem"><b>Problem</b></label><br/>
            <input type="text" name="problem" value="<?php echo $r[4]; ?>"/><br/><br/>
